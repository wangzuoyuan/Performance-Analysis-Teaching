...
```bash
cp compose.env.example .env       # 默认固定 IMAGE_TAG=2.0.9
cp backend/.env.example backend/.env
# 填好 backend/.env 后：
...
当前版本 **2.0.9**。完整变更见 [CHANGELOG.md](CHANGELOG.md)，历史版本见 [Releases](https://github.com/wangzuoyuan/Performance-Analysis-Teaching/releases)。
